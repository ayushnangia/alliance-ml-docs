...
- English
- [français](Accessing_object_storage_with_s3cmd_fr.md)
...
Instructions on [managing bucket policies](Arbutus_Object_Storage.md#Managing_data_container_(bucket)_policies_for_your_Arbutus_Object_Store) for your object store, including examples using s3cmd are available on the main [object storage](Arbutus_Object_Storage.md) page.