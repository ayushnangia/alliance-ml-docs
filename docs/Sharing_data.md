...
1. Send email to our [technical support](Technical_Support.md) requesting creation of data sharing group, indicate name of the group you would like to have and that you should be the owner.
...
[![Services screen displaying groups you can manage](/mediawiki/images/1/1d/Cc_services_screen.png)](FileCc_services_screenpng.md)

3. Click on the group's name and enter the group management screen:  
[![Services screen showing group's owner](/mediawiki/images/8/8f/Cc_service_management_screen.png)](FileCc_service_management_screenpng.md)

4. Add member (Victor Van Doom with CCI vdv-888, for example) to the group as a member:  
[![Services screen showing members of the group](/mediawiki/images/3/35/Cc_service_add_member_success_screen.png)](FileCc_service_add_member_success_screenpng.md)
