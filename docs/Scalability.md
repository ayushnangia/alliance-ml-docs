...
1. ↑ Wikipedia, "Super-linear speedup": [https://en.wikipedia.org/wiki/Speedup#Super-linear\_speedup](https://en.wikipedia.org/wiki/Speedup#Super-linear_speedup)
2. ↑ Wikipedia, "Fast Fourier transform: [https://en.wikipedia.org/wiki/Fast\_Fourier\_transform](https://en.wikipedia.org/wiki/Fast_Fourier_transform)