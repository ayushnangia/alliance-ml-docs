...
You may find others by checking the list of [available software](Available_software.md) and looking for entries with type "geo".
...
We recommend you contact your institution's IT services department or the vendor [Esri](https://www.esri.com) to see what options are available for you,
either on your personal computer, at your institution, or through a commercial cloud provider like [AWS](https://aws.amazon.com/?nc1=h_ls) or [Azure](https://azure.microsoft.com/en-ca/).