...
Rorqual, Fir, Nibi, NarvalTrillium
...
debugjob
This will connect you to a node, let's say for the argument "niaXYZW".3. Run your visualization program, eg. VMD
module load vmd
vmd4. Exit the debug session.
