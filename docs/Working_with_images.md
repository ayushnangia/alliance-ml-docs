...
- English
- [français](Working_with_images_fr.md)
...
See [Creating an image from a volume](Working_with_volumes.md#Creating_an_image_from_a_volume).
...
To accept the shared image a member in the second project uses the [OpenStack](OpenStack_Command_Line_Clients.md#Separate_Command-line_interfaces) command below.
