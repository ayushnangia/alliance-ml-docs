...
Runtime is limited on the login nodes, so you should request an [interactive job](Scheduler.md#Interactive_jobs) to have more time for exploring and visualizing your data. Additionally, by doing so, you will be able to use more cores for faster processing.
