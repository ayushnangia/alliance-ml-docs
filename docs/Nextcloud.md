...
- **Server URL:** [https://nextcloud.computecanada.ca](https://nextcloud.computecanada.ca)
...
In general, you can use any WebDAV clients to "mount" a Nextcloud folder to your computer using the following WebDAV URL: [https://nextcloud.computecanada.ca/remote.php/webdav/](https://nextcloud.computecanada.ca/remote.php/webdav/)
...
**Windows:** Use the "Map Network Drive ..." option, select a drive letter, then use WebDAV URL [https://nextcloud.computecanada.ca/remote.php/webdav/](https://nextcloud.computecanada.ca/remote.php/webdav/) in the Folder field.
