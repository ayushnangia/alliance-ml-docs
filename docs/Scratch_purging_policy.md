...
- On Cedar, Beluga, and Narval clusters go to the **/scratch/to\_delete/** path and look for a file with your name.
- On Niagara go to **/scratch/t/to\_delete/** (symlink to /scratch/t/todelete/current)
