...
The latest version of matrix\_multiply (uses cmake to build) can be found [here](https://github.com/oneapi-src/oneAPI-samples/tree/master/Tools/VTuneProfiler).
...
After the program finishes, the profiling data will be stored in a directory called aps\_result\_YYYYMMDD where YYYYMMDD is the current date.
...
[![](/mediawiki/images/thumb/4/40/Vtune_mpi_profiling_report.png/800px-Vtune_mpi_profiling_report.png)](FileVtune_mpi_profiling_reportpng.md)
