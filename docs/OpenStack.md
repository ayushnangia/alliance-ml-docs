...
- English
- [français](Managing_your_cloud_resources_with_OpenStack_fr.md)
...
[![](/mediawiki/images/thumb/c/ca/Default_security_group_EN.png/400px-Default_security_group_EN.png)](FileDefault_security_group_ENpng.md)
...
[![](/mediawiki/images/thumb/2/25/VM_multi_user_cloud_init.png/400px-VM_multi_user_cloud_init.png)](FileVM_multi_user_cloud_initpng.md)
...
Once this is done, users can log into the VM with their private keys as usual (see [SSH Keys](SSH_Keys.md)).