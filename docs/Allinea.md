...
As this is a GUI application, log in using `ssh -Y`, and use an [SSH client](SSH.md) like [MobaXTerm](Connecting_with_MobaXTerm.md) (Windows) or [XQuartz](https://www.xquartz.org/) (Mac) to ensure proper X11 tunnelling.
...
[![](/mediawiki/images/thumb/f/f4/DDT-VNC-1.png/400px-DDT-VNC-1.png)](FileDDT-VNC-1png.md)

DDT on **gra-vdi.computecanada.ca**

[![](/mediawiki/images/thumb/a/a6/DDT-VNC-2.png/400px-DDT-VNC-2.png)](FileDDT-VNC-2png.md)
...
After you are done using DDT, you can if you like restore permissions to what they were (assuming you recorded them). More information on how to do this can be found on page [Sharing\_data](Sharing_data.md).
