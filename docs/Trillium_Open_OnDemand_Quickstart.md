...
- English
- [français](Trillium_Open_OnDemand_Quickstart_fr.md)

|  |
| --- |

This page is specifically for the Open OnDemand service attached to Trillium. General information on the Open OnDemand instances in the clusters of the Alliance can be found on [Open\_OnDemand](Open_OnDemand.md).
...
[![](/mediawiki/images/thumb/d/d4/Ood-dashboard.png/600px-Ood-dashboard.png)](SpecialFilePath_ood-dashboardpng.md)

Figure 1: Dashboard.

To access the Open OnDemand portal, open a web browser and navigate to the following page: [https://ondemand.scinet.utoronto.ca](https://ondemand.scinet.utoronto.ca). You will be prompted to enter your Alliance username and password, followed by a second factor authentication via Duo or Yubikey. Once you have logged in, you will be taken to the Open OnDemand dashboard. From here you can access the various tools and applications available on the platform.

# File management

[![](/mediawiki/images/thumb/9/98/Ood-file-browser.png/600px-Ood-file-browser.png)](SpecialFilePath_ood-file-browserpng.md)
...
The current file size upload limit is 10GB, if you need to upload a file larger than this or are facing upload issues due to a bad internet connection for example please try using [Globus](https://docs.scinet.utoronto.ca/index.php/Globus). There is a Globus button in the file browser at the top right, [![](/mediawiki/images/thumb/6/69/Globus_button.png/300px-Globus_button.png)](SpecialFilePath_Globus_buttonpng.md), which will take you to the Globus web interface where you can log in with your Alliance username and password. The path navigated to in the Open OnDemand file browser will be the same path opened in Globus.
...
[![](/mediawiki/images/8/8c/Ood-oc-shortcuts.png)](SpecialFilePath_ood-oc-shortcutspng.md)
...
- **Cluster**: allows you to change which cluster to submit your job to, e.g. Trillium (default) or Trillium-GPU. Selecting Trillium-GPU will provide an additional job parameter to request GPU resources [![](/mediawiki/images/thumb/7/7c/Ood-oc-gpus.png/100px-Ood-oc-gpus.png)](SpecialFilePath_ood-oc-gpuspng.md).

Once you are happy with your job script, click on the **Submit** button to submit the job to the scheduler and save your script to the **Script Location**. If your job was submitted successfully, you will see a confirmation message at the top of the page with your job ID: [![](/mediawiki/images/thumb/1/19/Ood-oc-job-submit.png/400px-Ood-oc-job-submit.png)](SpecialFilePath_ood-oc-job-submitpng.md).

[![](/mediawiki/images/thumb/5/50/Ood-oc-job.png/600px-Ood-oc-job.png)](SpecialFilePath_ood-oc-jobpng.md)
...
[![](/mediawiki/images/thumb/c/c2/Ood-oc-history.png/600px-Ood-oc-history.png)](SpecialFilePath_ood-oc-historypng.md)
...
[![](/mediawiki/images/thumb/0/02/Ood-active-jobs.png/600px-Ood-active-jobs.png)](SpecialFilePath_ood-active-jobspng.md)
...
- GPU resources (**Note**: only the **h100\_1.10** [MIG](https://docs.alliancecan.ca/wiki/Multi-Instance_GPU) profile is currently available, which provides 10GB of memory and 1/8 of the compute resources of a full NVIDIA H100 GPU.)
...
| Figure 7: Interactive app submission form. | Figure 8: Interactive sessions page. | Figure 9: Interactive app session. |
| --- | --- | --- |
...
[![](/mediawiki/images/thumb/a/ae/Ood-desktop-octave.png/600px-Ood-desktop-octave.png)](SpecialFilePath_ood-desktop-octavepng.md)

Figure 10: Octave GUI running in a Trillium Desktop.

# Terminal access

[![](/mediawiki/images/thumb/7/7b/Ood-terminal.png/600px-Ood-terminal.png)](SpecialFilePath_ood-terminalpng.md)
...
[![](/mediawiki/images/thumb/e/e7/Ood-session-id.png/600px-Ood-session-id.png)](SpecialFilePath_ood-session-idpng.md)

Figure 12: Accessing error logs via the session card
