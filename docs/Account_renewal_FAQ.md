...
- English
- [français](Account_renewal_FAQ_fr.md)
...
If you want to have several roles, add a new role by going to [https://ccdb.alliancecan.ca/me/add\_role](https://ccdb.alliancecan.ca/me/add_role) and click on “disable old roles” on that page. It is possible to submit several applications, but you can only set one of them as your primary role.
