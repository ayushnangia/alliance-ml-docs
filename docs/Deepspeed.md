...
In the example that follows, we use deepspeed to reproduce our [PyTorch tutorial](PyTorch.md#PyTorch_with_Multiple_GPUs) on how to train a model with multiple GPUs distributed over multiple nodes. Notable differences are:
...
**File :** launch\_training\_deepspeed.sh
