...
- [**Jupyter Notebook via JupyterHub**: a pre-installed Jupyter Notebook environment](JupyterHub.md#User_Interface), with a default Python kernel and the access to software modules
