...
Before you can start using [CPMD](http://cpmd.org) on our clusters, [send us a support request](Technical_Support.md) and ask to be added to the POSIX group that will allow you to access the software.

# Module

You can access CPMD by loading a [module](Utiliser_des_modules.md).
