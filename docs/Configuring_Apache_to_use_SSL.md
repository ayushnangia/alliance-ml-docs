...
- English
- [français](Configuring_Apache_to_use_SSL_fr.md)
...
1. **Activate the SSL module**  
   Once Apache has been installed (see [Installing Apache](Creating_a_web_server_on_a_cloud.md#Install_Apache2)), the SSL module must be enabled with
