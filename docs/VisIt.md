...
If your account has multifactor authentication enabled, you will need to [configure your SSH client with ControlMaster](Multifactor_authentication.md#Configuring_your_SSH_client_with_ControlMaster) and make sure to use the full host name for Host, e.g.
...
Download the Trillium host file, right-click on [host\_trillium.xml](https://support.scinet.utoronto.ca/~mponce/viz/host_trillium.xml) and select *Save as.*
