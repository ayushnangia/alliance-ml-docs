...
For example, if an administrator at MIla wants to see the list of email addresses of the users that a) have requested Tier 3 access (which is done in this page [https://ccdb.alliancecan.ca/paice/general\_access\_to\_paice\_systems](https://ccdb.alliancecan.ca/paice/general_access_to_paice_systems)) and b) have also requested access to Tamia ([https://ccdb.alliancecan.ca/me/access\_systems](https://ccdb.alliancecan.ca/me/access_systems)), then follow these steps (the same process applies if the intention is to get a list from a Tier4 service):
  
  
1. Go to `Browse` → `Services` in the main CCDB menu.

[![](/mediawiki/images/thumb/a/a2/Screenshot_2026-02-18_at_4.41.24_PM.png/300px-Screenshot_2026-02-18_at_4.41.24_PM.png)](FileScreenshot_2026-02-18_at_44124_PMpng.md)

2. Type in “tier3” in the search box of the Generic services table

[![](/mediawiki/images/thumb/f/f2/Screenshot_2026-02-18_at_4.42.38_PM.png/300px-Screenshot_2026-02-18_at_4.42.38_PM.png)](FileScreenshot_2026-02-18_at_44238_PMpng.md)
...
[![](/mediawiki/images/thumb/0/02/Screenshot_2026-02-18_at_4.18.31_PM.png/300px-Screenshot_2026-02-18_at_4.18.31_PM.png)](FileScreenshot_2026-02-18_at_41831_PMpng.md)

6. Scroll down to the bottom of the page and in the search box of the System agreements panel, type in “tamia”.

[![](/mediawiki/images/thumb/9/9f/Screenshot_2026-02-18_at_4.18.02_PM.png/300px-Screenshot_2026-02-18_at_4.18.02_PM.png)](FileScreenshot_2026-02-18_at_41802_PMpng.md)
