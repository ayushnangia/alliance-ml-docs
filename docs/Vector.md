...
| Home space | Location of /home directories. Each /home directory has a small fixed quota . Larger requests go to the /project space. Has daily backup |
| --- | --- |
| Scratch space | For active or temporary (scratch) storage. Large fixed quota per user. Inactive data will be purged . |
