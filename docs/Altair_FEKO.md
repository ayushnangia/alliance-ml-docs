...
and put this file in the folder $HOME/.licenses/. Note that firewall configuration will need to be done on both our side and yours. Please get in touch with our [Technical support](Technical_Support.md) to arrange this.