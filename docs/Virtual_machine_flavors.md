...
- English
- [français](Virtual_machine_flavors_fr.md)
...
Researchers are able to view all the flavors they have been allocated for their project. These can be seen in the Horizon Dashboard and via the [OpenStack command line client](OpenStack_Command_Line_Clients.md) with the following command:
...
[![Openstack flavors](/mediawiki/images/thumb/8/84/Flavors.png/300px-Flavors.png)](FileFlavorspng.md)
