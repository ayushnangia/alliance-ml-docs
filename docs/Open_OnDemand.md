...
- [Nibi Open OnDemand Quickstart](Nibi.md#Access_through_Open_OnDemand_(OOD))

# Logging into the Open OnDemand portal

[![](/mediawiki/images/thumb/d/d4/Ood-dashboard.png/600px-Ood-dashboard.png)](FileOod-dashboardpng.md)

Figure 1: Example of Trillium dashboard.
...
[![](/mediawiki/images/thumb/9/98/Ood-file-browser.png/600px-Ood-file-browser.png)](FileOod-file-browserpng.md)

Figure 2: Example of Trillium file browser.
...
The current file size upload limit is 10GB, if you need to upload a file larger than this or are facing upload issues due to a bad internet connection for example please try using [Globus](Globus.md). There is a Globus button in the file browser at the top right, [![](/mediawiki/images/thumb/6/69/Globus_button.png/300px-Globus_button.png)](FileGlobus_buttonpng.md), which will take you to the Globus web interface where you can login with your Alliance username and password. The path navigated to in the Open OnDemand file browser will be the same path opened in Globus.

# Job submission

[![](/mediawiki/images/thumb/1/18/Ood-job-composer.png/600px-Ood-job-composer.png)](FileOod-job-composerpng.md)

Figure 3: Example of Trillium Job Composer.
...
[![](/mediawiki/images/thumb/0/02/Ood-active-jobs.png/600px-Ood-active-jobs.png)](FileOod-active-jobspng.md)

Figure 4: Example of Trillium Active Jobs.
...
| Figure 5: Interactive app submission form. | Figure 6: Interactive sessions page. Figure 7: Interactive app session. |
| --- | --- |

# Terminal access

[![](/mediawiki/images/thumb/7/7b/Ood-terminal.png/600px-Ood-terminal.png)](FileOod-terminalpng.md)

Figure 7: Example of Trillium Terminal

Sometimes you might prefer to use a terminal to interact with the cluster, Open OnDemand provides a web-based terminal that you can use to access the command line interface. To access the terminal, navigate to the **Clusters** tab and select **Cluster\_Name Shell Access**. This will open a new tab in your browser with a terminal window where you can run commands as you would in a regular terminal session.

# Debugging Errors

[![](/mediawiki/images/thumb/e/e7/Ood-session-id.png/600px-Ood-session-id.png)](FileOod-session-idpng.md)

Figure 8: Accessing error logs via the session card
