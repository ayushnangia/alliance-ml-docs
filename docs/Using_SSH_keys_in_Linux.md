...
- English
- [français](Using_SSH_keys_in_Linux_fr.md)
...
More details on best practices can be found [here](SSH_Keys.md#Best_practices_for_key_pairs).
...
Grab the content of your public key (called *id\_rsa.pub* in the above case) and upload it to CCDB as per step 3 of [these instructions](SSH_Keys.md#Using_CCDB).
...
- Same for your remote ~/.ssh and ~/.ssh/authorized\_keys  `chmod --recursive go-rwx ~/.ssh` .
