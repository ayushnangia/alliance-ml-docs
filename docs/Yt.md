...
We assume that you have downloaded the sample dataset Enzo\_64 from [http://yt-project.org/data](http://yt-project.org/data). Start with the following script `grids.py` to render 90 frames rotating the dataset around the vertical axis
