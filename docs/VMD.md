...
See [Using modules](Utiliser_des_modules.md) for more on the `module` command, including how to find and use other pre-installed versions.

## Installing version 1.9.4 Alpha

1. Download the 1.9.4 LATEST ALPHA tar file from [http://www.ks.uiuc.edu/](http://www.ks.uiuc.edu/Development/Download/download.cgi?PackageName=VMD), selecting the LINUX\_64 version. Free registration is required.
