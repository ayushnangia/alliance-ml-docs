...
- English
- [français](RAC_FAQ_fr.md)

If you have questions about the terminology, please consult our [Technical Glossary](https://docs.computecanada.ca/wiki/Technical_glossary_for_the_resource_allocation_competitions).
...
Learn [more about the competition](Resource_Allocation_Competition.md).
...
Yes. A list of key terms used in the competition and application process is available. Please consult the [Technical Glossary](Technical_glossary_for_the_resource_allocation_competitions.md) when preparing your application.
...
For more information, visit the [Allocation and compute scheduling page](Allocations_and_compute_scheduling.md).
