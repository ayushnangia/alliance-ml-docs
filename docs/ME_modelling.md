...
Get solvemepy from GitHub ([https://github.com/SBRG/solvemepy](https://github.com/SBRG/solvemepy)):
...
Get CobraME from GitHub ([https://github.com/SBRG/cobrame](https://github.com/SBRG/cobrame)) and install:
...
Get EcoliME from GitHub ([https://github.com/SBRG/ecolime/tree/master/ecolime](https://github.com/SBRG/ecolime/tree/master/ecolime)) and install:
...
3. ↑ 3.0 3.1 [Lloyd CJ, Ebrahim A, Yang L, King ZA, Catoiu E, O’Brien EJ, et al. (2018) COBRAme: A computational framework for genome-scale models of metabolism and gene expression. PLoS Comput Biol. 2018;14: e1006302.](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1006302)
