...
- English
- [français](User_roles_to_access_resources_and_services_of_the_Alliance_Federation_fr.md)
...
| --- | --- | --- | --- |
| Academic Principal Investigator | Faculty | You are a full-time or part-time faculty member at a Canadian university, college or research hospital that is eligible to hold CFI grants. | - Can access Federation resources and services free of charge. - Is eligible to request resources via the Rapid Access Service (RAS). - Is eligible to apply to the Resource Allocation Competitions (RAC). - Can sponsor users. |
