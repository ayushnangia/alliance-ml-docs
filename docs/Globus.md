...
[![](/mediawiki/images/thumb/9/91/Globus-Login-Organization.png/400px-Globus-Login-Organization.png)](FileGlobus-Login-Organizationpng.md)

Choose Digital Research Alliance of Canada for Globus Organization dropdown (click on image to enlarge)

[![](/mediawiki/images/thumb/9/97/DRAC-Shibboleth-Login.png/400px-DRAC-Shibboleth-Login.png)](FileDRAC-Shibboleth-Loginpng.md)
...
[![](/mediawiki/images/thumb/c/ce/Globus-file-manager.png/400px-Globus-file-manager.png)](FileGlobus-file-managerpng.md)
...
[![](/mediawiki/images/thumb/4/4b/Globus-select-collection-rorqual.png/400px-Globus-select-collection-rorqual.png)](FileGlobus-select-collection-rorqualpng.md)
...
| --- | --- | --- |
| Fir Narval Nibi Rorqual | Trillium | Killarney TamIA Vulcan |
...
[![](/mediawiki/images/thumb/c/ce/Globus-Initiate-Transfer.png/400px-Globus-Initiate-Transfer.png)](FileGlobus-Initiate-Transferpng.md)
...
[![](/mediawiki/images/thumb/f/f0/GetGlobusConnectPersonal.png/400px-GetGlobusConnectPersonal.png)](FileGetGlobusConnectPersonalpng.md)
...
[![](/mediawiki/images/thumb/d/d9/Gcp-applet.png/400px-Gcp-applet.png)](FileGcp-appletpng.md)
...
On [general-purpose clusters](National_systems.md#Compute_clusters), Globus sharing is enabled for the `/home` directory, except on the Rorqual cluster. If you would like to test a Globus share you can create one in your `/home` directory.
...
Log into [the Alliance Globus portal](https://globus.alliancecan.ca) with your Globus credentials. Once you are logged in, you will see a transfer window. In the *endpoint* field, type the endpoint identifier for the endpoint you wish to share from (e.g. alliancecan#fir, computecanada#graham-globus, alliancecan#rorqual, alliancecan#trillium\_home etc.) and activate the endpoint if asked to.

[![](/mediawiki/images/thumb/7/76/Globus_SharedEndpoint1-1024x607.png/300px-Globus_SharedEndpoint1-1024x607.png)](FileGlobus_SharedEndpoint1-1024x607png.md)
...
[![](/mediawiki/images/thumb/9/9e/Globus_SharedEndpoint2.png/300px-Globus_SharedEndpoint2.png)](FileGlobus_SharedEndpoint2png.md)
...
[![](/mediawiki/images/thumb/c/ce/Globus_SharedEndpoint3-1024x430.png/300px-Globus_SharedEndpoint3-1024x430.png)](FileGlobus_SharedEndpoint3-1024x430png.md)
...
[![](/mediawiki/images/thumb/8/82/Globus_ManagingAccess-1024x745-changed.png/300px-Globus_ManagingAccess-1024x745-changed.png)](FileGlobus_ManagingAccess-1024x745-changedpng.md)
...
[![](/mediawiki/images/thumb/2/23/Globus-Add-Permissions.png/300px-Globus-Add-Permissions.png)](FileGlobus-Add-Permissionspng.md)
...
[![](/mediawiki/images/thumb/c/cc/Globus_RemovingSharedEndpoint-1024x322.png/300px-Globus_RemovingSharedEndpoint-1024x322.png)](FileGlobus_RemovingSharedEndpoint-1024x322png.md)
...
[![](/mediawiki/images/thumb/f/f4/Globus_CreatingNewGroup-1024x717.png/300px-Globus_CreatingNewGroup-1024x717.png)](FileGlobus_CreatingNewGroup-1024x717png.md)
...
1. Create a virtual environment to install the Globus CLI into (see [creating and using a virtual environment](Python.md#Creating_and_using_a_virtual_environment)).
...
2. Activate the virtual environment.
   ...
   ```
3. Install Globus CLI into the virtual environment (see [installing modules](Python.md#Installing_modules)).
...
To access the Arbutus object storage, generate the storage **access ID** and **secret key** with the [OpenStack command line client](OpenStack_Command_Line_Clients.md).  
...
[![Globus Arbutus S3 bucket Endpoint](/mediawiki/images/thumb/6/6f/ArbutusS3Endpoint.png/400px-ArbutusS3Endpoint.png)](FileArbutusS3Endpointpng.md)

Globus Arbutus S3 bucket endpoint (click on image to enlarge)
...
[![Globus Arbutus S3 bucket S3 Keys](/mediawiki/images/thumb/7/76/ArbutusObjectStorageBucketKeys.png/400px-ArbutusObjectStorageBucketKeys.png)](FileArbutusObjectStorageBucketKeyspng.md)

Globus Arbutus S3 bucket Keys (Click for larger image.)
