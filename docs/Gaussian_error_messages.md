...
- English
- [français](Gaussian_error_messages_fr.md)
...
- your disk quota was exceeded (see [File quotas and policies](Filesystem.md#Filesystem_quotas_and_policies));
- the job exceeded the time requested from the [scheduler](Scheduler.md) (`--time=HH:MM:SS`);
- the job exceeded the memory requested (`--mem=`) (see [Monitoring jobs](Scheduler.md#Monitoring̠_jobs)); or
