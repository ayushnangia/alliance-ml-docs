...
- English
- [français](Advanced_MPI_scheduling_fr.md)

Most users should submit MPI or distributed memory parallel jobs following the example
given at [Running jobs](Scheduler.md#MPI_job). Simply request a number of
...
**File :** whole\_nodes\_trillium.sh
...
- [Fir node characteristics](Fir.md#Node_characteristics)
- [Narval node characteristics](Narval.md#Node_characteristics)
- [Nibi node characteristics](Nibi.md#Node_characteristics)
- [Rorqual node characteristics](Rorqual.md#Node_characteristics)
...
**File :** less\_than\_whole\_node.sh
...
Not every application runs with maximum efficiency on a multiple of 32 (or 40, or 48) cores. Choosing the number of cores to request—and whether or not to request whole nodes—may be a trade-off between *running* time (or efficient use of the computer) and *waiting* time (or efficient use of your time). If you want help evaluating these factors, please contact [Technical support](Technical_Support.md).
