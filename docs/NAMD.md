...
NAMD is installed by our software team and is available as a module. If a new version is required or if for some reason you need to do your own installation, please contact [Technical support](Technical_Support.md). You can also ask for details of how our NAMD modules were compiled.
...
Please refer to the [Running jobs](Scheduler.md) page for help on using the SLURM workload manager.
...
**File :** multicore\_gpu\_namd\_job.sh
