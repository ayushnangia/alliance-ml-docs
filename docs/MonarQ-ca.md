...
MonarQ is a 24-qubit superconducting quantum computer developed in Montreal by [Anyon Systems](https://anyonsys.com/) and located at the [École de technologie supérieure](http://www.etsmtl.ca/). See section Technical specifications below.
...
- [Qiskit](Qiskit_fr.md), for Python commands
...
- **Step 3: Configure your identifiers on MonarQ and define MonarQ as your device**
  ...
  - For more information, see [pennylane\_calculquebec](https://github.com/calculquebec/pennylane-calculquebec/blob/main/doc/getting_started.ipynb).
...
- For more information on submitting tasks on Narval, see [Running jobs](Scheduler.md).
