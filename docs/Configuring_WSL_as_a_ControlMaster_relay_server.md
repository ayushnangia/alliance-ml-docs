...
- English
- [français](Configuring_WSL_as_a_ControlMaster_relay_server_fr.md)
...
### Log into the Ubuntu VM and create a *custom\_ssh* folder
...
You may copy the *ssh\_host* keys from */etc/ssh* with:
