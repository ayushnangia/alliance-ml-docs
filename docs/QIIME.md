...
So your [SBATCH](Scheduler.md) script might look something like this:
...
Note that it is important to use the [bind](Apptainer.md#Bind_mounts) option (`-B`) with each folder you want to work with when you run programs in your container. For more information about Apptainer, you can watch this [Apptainer webinar](https://www.youtube.com/watch?v=bpmrfVqBowY).
