...
- English
- [français](OpenACC_Tutorial_-_Optimizing_loops_fr.md)
...
Correspondance between OpenACC and CUDA
...
- gang size is given by the number of workers times the size of a vector. This number cannot be larger than 1024.
...
If you prefer the parallel loop directive, the vector length is specified at the level of the top loop with the vector\_length clause. The vector clause is then used to specify to parallelize an inner loop over vector. The example becomes:
...
[![](/mediawiki/images/thumb/3/38/0-guided_analysis.png/300px-0-guided_analysis.png)](File0-guided_analysispng.md)

First step of guided analysis

[![](/mediawiki/images/thumb/4/49/1-guided_analysis.png/300px-1-guided_analysis.png)](File1-guided_analysispng.md)

Second step of guided analysis

[![](/mediawiki/images/thumb/6/6c/2-guided_analysis.png/300px-2-guided_analysis.png)](File2-guided_analysispng.md)

Third step of guided analysis

[![](/mediawiki/images/thumb/4/4c/3-guided_analysis.png/300px-3-guided_analysis.png)](File3-guided_analysispng.md)

Fourth step of guided analysis

As instructed in the [third section](OpenACC_Tutorial_-_Adding_directives.md#How_is_ported_code_performing_.3F) of this tutorial, open the NVidia Visual Profiler and start a new session with the latest executable we have built. Then, follow the following steps (see beside for screenshots of each step):
...
[![Fifth step of guided analysis](/mediawiki/images/thumb/c/ce/4-guided_analysis.png/800px-4-guided_analysis.png)](File4-guided_analysispng.md)
