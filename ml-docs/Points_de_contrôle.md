...
- English
- [français](Points_de_contrôle.md)
...
If you plan on breaking up a lengthy computation into several Slurm jobs, there are [two recommended methods](Scheduler.md#Resubmitting_jobs_for_long_running_computations):

- [using Slurm job arrays](Scheduler.md#Restarting_using_job_arrays);
- [resubmission from the end of the job script](Scheduler.md#Resubmission_from_the_job_script).