...
- English
- [français](Technical_support_fr.md)
...
- globus@tech.alliancecan.ca -- Questions about **[Globus](Globus.md)** file transfer services
- cloud@tech.alliancecan.ca -- Questions about using **[Cloud](Cloud.md)** resources
...
- trillium@tech.alliancecan.ca -- For questions or issues regarding to the [Trillium](Trillium.md) cluster specifically
...
- Avoid sending screenshots or other large image attachments except when necessary - the plain text of your commands, job script etc. is usually more helpful. See [Copy and paste](Frequently_Asked_Questions.md#Copy_and_paste) if you have trouble with this.
