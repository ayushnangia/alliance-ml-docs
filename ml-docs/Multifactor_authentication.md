...
- English
- [français](Multifactor_authentication_fr.md)
...
- [![Step 1](/mediawiki/images/4/4d/Duo-mobile-app-icon.png)](FileDuo-mobile-app-iconpng.md)

  Step 1
- [![Step 3](/mediawiki/images/thumb/6/6b/Duo-mobile-option-en.png/300px-Duo-mobile-option-en.png)](FileDuo-mobile-option-enpng.md)

  Step 3
- [![Step 4](/mediawiki/images/thumb/b/b8/Naming-duo-mobile-device-en.png/300px-Naming-duo-mobile-device-en.png)](FileNaming-duo-mobile-device-enpng.md)

  Step 4
- [![Step 5](/mediawiki/images/thumb/9/9d/Duo-mobile-add-account.png/170px-Duo-mobile-add-account.png)](FileDuo-mobile-add-accountpng.md)

  Step 5
- [![Step 6](/mediawiki/images/thumb/3/3e/Duo-mobile-scan-qr-code.png/170px-Duo-mobile-scan-qr-code.png)](FileDuo-mobile-scan-qr-codepng.md)

  Step 6
- [![Step 7](/mediawiki/images/thumb/4/4c/Scanning-CCDB-QR-code.jpg/237px-Scanning-CCDB-QR-code.jpg)](FileScanning-CCDB-QR-codejpg.md)
...
1. Download and install the YubiKey Authenticator application from the [Yubico website](https://www.yubico.com/products/yubico-authenticator/).
2. Insert your YubiKey and launch the YubiKey Authenticator software.
3. In YubiKey Authenticator, select *Slots*. (Images below illustrate this and the next few steps.)
4. Select either slot 1 or slot 2. Slot 1 corresponds to a short touch (pressing for 1 to 2.5 seconds), while slot 2 is a long touch on the key (pressing for 3 to 5 seconds). Slot 1 is typically pre-registered for Yubico cloud mode. If you are already using this slot for other services, either use slot 2, or click on *Swap slots* to transfer the configuration to slot 2 before configuring slot 1.
5. Select *Yubico OTP / Program a Yubico OTP credential*.
6. In the "Public ID" field click *Use serial*, then generate a Private ID and a Secret key. **Securely save a copy of the data in the Public ID, Private ID, and Secret key fields, as you will need them shortly.**
7. **IMPORTANT: Click on "Save".**
8. Log into the CCDB to register your YubiKey in the *[Multifactor authentication management page](https://ccdb.alliancecan.ca/multi_factor_authentications)*.

- [![Step 3](/mediawiki/images/thumb/9/97/Yubico-Authenticator-Step3.png/300px-Yubico-Authenticator-Step3.png)](FileYubico-Authenticator-Step3png.md)

  Step 3
- [![Step 4, Step 5](/mediawiki/images/thumb/f/f1/Yubico-Authenticator-Step4.png/300px-Yubico-Authenticator-Step4.png)](FileYubico-Authenticator-Step4png.md)

  Step 4, Step 5
- [![Step 6](/mediawiki/images/thumb/5/52/Yubico-Authenticator-Step6.png/300px-Yubico-Authenticator-Step6.png)](FileYubico-Authenticator-Step6png.md)

  Step 6
- [![Step 7](/mediawiki/images/thumb/4/4a/Yubico-Authenticator-Step7.png/300px-Yubico-Authenticator-Step7.png)](FileYubico-Authenticator-Step7png.md)

  Step 7
- [![Step 8](/mediawiki/images/thumb/6/69/CCDB_Yubikeys.png/300px-CCDB_Yubikeys.png)](FileCCDB_Yubikeyspng.md)
...
- [![](/mediawiki/images/thumb/e/e6/CCDB_MFA_prompt.png/300px-CCDB_MFA_prompt.png)](FileCCDB_MFA_promptpng.md)
