...
- English
- [français](Transferring_data_fr.md)
...
If it takes more than one minute to move your files to or from our servers, we recommend you install and try [Globus Personal Connect](Globus.md#Personal_Computers). [Globus](Globus.md) transfers can be set up and will run in the background.
...
[!["Globus file transfer sync options"](/mediawiki/images/thumb/7/75/Globus_Transfer_Sync_Options.png/280px-Globus_Transfer_Sync_Options.png)](FileGlobus_Transfer_Sync_Optionspng.md)
...
[![](/mediawiki/images/thumb/3/30/Question.png/40px-Question.png)](https://explainshell.com/explain?cmd=rsync+-avzh+--no-g+--no-p+--partial+--progress+LOCALNAME+someuser%40nibi.alliancecan.ca%3Aprojects%2Fdef-professor%2Fsomeuser%2Fsomedir%2F)
...
[![](/mediawiki/images/thumb/3/30/Question.png/40px-Question.png)](https://explainshell.com/explain?cmd=rsync+-azh+--no-g+--no-p+--info%3Dprogress2+LOCALNAME+someuser%40nibi.alliancecan.ca%3Aprojects%2Fdef-professor%2Fsomeuser%2Fsomedir%2F)
...
[![](/mediawiki/images/thumb/3/30/Question.png/40px-Question.png)](https://explainshell.com/explain?cmd=rsync+-avzh+--no-g+--no-p+someuser%40nibi.alliancecan.ca%3AREMOTENAME+%7E%2Fprojects%2Fdef-professor%2Fsomeuser%2Fsomedir%2F)
...
[![](/mediawiki/images/thumb/3/30/Question.png/40px-Question.png)](https://explainshell.com/explain?cmd=rsync+-avh+--no-g+--no-p+LOCALNAME+%7E%2Fprojects%2Fdef-professor%2Fsomeuser%2Fsomedir%2F)
...
[![](/mediawiki/images/thumb/3/30/Question.png/40px-Question.png)](https://explainshell.com/explain?cmd=cp+-rv+--preserve%3D%22mode%2Ctimestamps%22+LOCALNAME+%7E%2Fprojects%2Fdef-professor%2Fsomeuser%2Fsomedir%2F)
...
[![](/mediawiki/images/thumb/3/30/Question.png/40px-Question.png)](https://explainshell.com/explain?cmd=find+%2Fhome%2Fusername%2F+-type+f+-print0+%7C+xargs+-0+sha1sum+%7C+tee+checksum-result.log)
...
[![](/mediawiki/images/thumb/3/30/Question.png/40px-Question.png)](https://explainshell.com/explain?cmd=diff+checksum-result-silo.log+checksum-dtn.log)
...
SCP stands for [*Secure Copy Protocol*](https://en.wikipedia.org/wiki/Secure_copy). Like SFTP it uses the SSH protocol to encrypt data being transferred. It does not support synchronization like [Globus](Globus.md) or rsync. Some examples of the most common use of SCP include

[![](/mediawiki/images/thumb/3/30/Question.png/40px-Question.png)](https://explainshell.com/explain?cmd=scp+foo.txt+username%40rorqual.alliancecan.ca%3Awork%2F)
...
[![](/mediawiki/images/thumb/3/30/Question.png/40px-Question.png)](https://explainshell.com/explain?cmd=scp+username%40fir.alliancecan.ca%3Aprojects%2Fdef-jdoe%2Fusername%2Fresults%2Foutput.dat+.)
...
[![](/mediawiki/images/thumb/3/30/Question.png/40px-Question.png)](https://explainshell.com/explain?cmd=scp+-i+%2Fpath%2Fto%2Fkey+foo.txt+username%40rorqual.alliancecan.ca%3Awork%2F)
...
[![](/mediawiki/images/thumb/3/30/Question.png/40px-Question.png)](https://explainshell.com/explain?cmd=find+%3Cdirectory_name%3E+%21+-readable+-ls)
...
- Double-check the **[storage usage](Storage_and_file_management.md#Overview)** and make sure enough space and enough files are available.
...
[![](/mediawiki/images/thumb/3/30/Question.png/40px-Question.png)](https://explainshell.com/explain?cmd=du+dataset%3B+du+-b+dataset)
...
- Double-check the **[filesystem permissions](Sharing_data.md)** and make sure you have the write permission at the location where you are trying to transfer new files.