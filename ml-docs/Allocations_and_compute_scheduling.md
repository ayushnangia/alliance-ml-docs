...
- English
- [français](Allocations_and_compute_scheduling_fr.md)

*Parent page: [Job scheduling policies](Job_scheduling.md)*
...
[![](/mediawiki/images/c/c9/Core_equivalent_diagram_GP.png)](FileCore_equivalent_diagram_GPpng.md)

Figure 1 - Core equivalent diagram.
...
- [![](/mediawiki/images/1/18/Two_core_equivalents.png)](FileTwo_core_equivalentspng.md)
...
- [![](/mediawiki/images/9/90/Two_and_a_half_core_equivalents.png)](FileTwo_and_a_half_core_equivalentspng.md)
...
[![](/mediawiki/images/thumb/f/f0/GPU_equivalent_diagram.png/330px-GPU_equivalent_diagram.png)](FileGPU_equivalent_diagrampng.md)

Figure 4 - RGU equivalent diagram.
...
[![](/mediawiki/images/thumb/6/69/Two_GPU_equivalents.png/300px-Two_GPU_equivalents.png)](FileTwo_GPU_equivalentspng.md)

Figure 5 - Two RGU equivalents.
...
[![](/mediawiki/images/thumb/b/ba/GPU_and_a_half_%28cores%29.png/300px-GPU_and_a_half_%28cores%29.png)](FileGPU_and_a_half_corespng.md)

Figure 6 - 1.66 RGU equivalents, based on cores.
...
[![](/mediawiki/images/thumb/d/d0/GPU_and_a_half_%28memory%29.png/300px-GPU_and_a_half_%28memory%29.png)](FileGPU_and_a_half_memorypng.md)

Figure 7 - 1.5 RGU equivalents, based on memory.
...
[![](/mediawiki/images/thumb/e/ef/Two.Six_RGU_equivalents.png/630px-Two.Six_RGU_equivalents.png)](FileTwoSix_RGU_equivalentspng.md)
...
[![](/mediawiki/images/thumb/f/f4/Four_RGU_equivalents.png/800px-Four_RGU_equivalents.png)](FileFour_RGU_equivalentspng.md)
...
[![usage portal landing view](/mediawiki/images/thumb/0/0d/Slurm_portal_land_edit.png/300px-Slurm_portal_land_edit.png)](FileSlurm_portal_land_editpng.md)

Usage portal landing view. (Click on the image for a larger version.)
...
[![account usage](/mediawiki/images/thumb/f/fa/Slurm_portal_account_usage_edit_2.png/300px-Slurm_portal_account_usage_edit_2.png)](FileSlurm_portal_account_usage_edit_2png.md)

Usage display of a specified account

If you have access to more than one [Slurm account](Scheduler.md#Accounts_and_projects), the *Select user’s account* pull-down menu of the *SLURM account* panel lets you select which project account will be displayed in the figure window. If the *Select user’s account* is left empty the figure will display all of your usage across accounts on the specified cluster during the selected time period. The *Select user’s account* pull-down menu is populated by a list of all the accounts that have job records on the selected cluster during the selected time interval. Other accounts that you have access to but do not have usage on the selected cluster during the selected time interval will also appear in the pull-down menu but will be grayed out and not selectable as they would not generate a figure. When you select a single project account the figure is updated and the summary panel titled *Allocation Information* is populated with details of the project account. The height of each bar in the histogram figure corresponds to the metric for that day (e.g. CPU-equivalent days) across all users in the account on the system. The top seven users are displayed in unique colors stacked on top of the summed metric for all other users in gray. You can navigate the figure using [Plotly](https://plotly.com/graphing-libraries/) tools (zoom, pan, etc.) whose icons appear at the top-right when you hover your mouse over the figure window. You can also use the legend on the right-hand side to manipulate the figure. Single-clicking an item will toggle the item's presence in the figure, and double-clicking the item will toggle off or on all the other items in the figure.

## Options in the figure legend

[![figure legend](/mediawiki/images/thumb/e/e0/Slurm_portal_legend_edit.png/300px-Slurm_portal_legend_edit.png)](FileSlurm_portal_legend_editpng.md)
...
[![target and queued use](/mediawiki/images/thumb/6/68/Slurm_portal_account_usage_queued_edit_2.png/300px-Slurm_portal_account_usage_queued_edit_2.png)](FileSlurm_portal_account_usage_queued_edit_2png.md)

Allocation target and queued resources displayed on usage figure
...
[![mouse hover](/mediawiki/images/thumb/7/76/Slurm_portal_hover_total_plotly_edit.png/300px-Slurm_portal_hover_total_plotly_edit.png)](FileSlurm_portal_hover_total_plotly_editpng.md)

Additional figure options when hover the mouse over the figure window
...
[![default raw usage](/mediawiki/images/thumb/a/ab/Slurm_portal_def_rawusage.png/300px-Slurm_portal_def_rawusage.png)](FileSlurm_portal_def_rawusagepng.md)

Display of default account usage, including SLURM Raw Shares and SLURM Raw Usage
...
[![Select a specific cluster and time interval](/mediawiki/images/thumb/e/eb/Slurm_portal_select_sys_date.png/300px-Slurm_portal_select_sys_date.png)](FileSlurm_portal_select_sys_datepng.md)

Select a specific cluster and time interval
...
[![usage extended duration](/mediawiki/images/thumb/1/1f/Slurm_portal_account_use_duration_edit_2.png/300px-Slurm_portal_account_use_duration_edit_2.png)](FileSlurm_portal_account_use_duration_edit_2png.md)

Display usage over an extended period into the future
...
[![Parameters of the usage series histogram](/mediawiki/images/thumb/b/bb/Slurm_portal_parameter_panel.png/300px-Slurm_portal_parameter_panel.png)](FileSlurm_portal_parameter_panelpng.md)
...
[![cumulative use](/mediawiki/images/thumb/a/a1/Slurm_portal_account_use_cumulative_edit_2.png/300px-Slurm_portal_account_use_cumulative_edit_2.png)](FileSlurm_portal_account_use_cumulative_edit_2png.md)

Display the running total of account usage
...
[![](/mediawiki/images/thumb/8/87/Select_view_group_usage_edit.png/300px-Select_view_group_usage_edit.png)](FileSelect_view_group_usage_editpng.md)

Navigation to *View Group Usage*
...
[![](/mediawiki/images/thumb/5/52/Ccdb_view_use_by_compute_resource.png/300px-Ccdb_view_use_by_compute_resource.png)](FileCcdb_view_use_by_compute_resourcepng.md)

CPU and GPU usage by compute resource
...
:   **Storage usage** is discussed in [Storage and file management](Filesystem.md).
...
[![](/mediawiki/images/thumb/e/e1/Ccdb_view_use_by_compute_resource_monthly.png/300px-Ccdb_view_use_by_compute_resource_monthly.png)](FileCcdb_view_use_by_compute_resource_monthlypng.md)

Usage by compute resource with monthly breakdown
...
[![](/mediawiki/images/thumb/e/ed/Ccdb_view_use_by_compute_resource_monthly_proj_edit.png/300px-Ccdb_view_use_by_compute_resource_monthly_proj_edit.png)](FileCcdb_view_use_by_compute_resource_monthly_proj_editpng.md)

Usage by Resource Allocation Project with monthly breakdown
...
[![GPU usage](/mediawiki/images/thumb/5/50/Rgu_en.png/300px-Rgu_en.png)](FileRgu_enpng.md)

GPU usage summary with Reference GPU Unit (RGU) breakdown table.
...
[![](/mediawiki/images/thumb/3/31/Ccdb_view_use_by_submitter_summary_edit.png/300px-Ccdb_view_use_by_submitter_summary_edit.png)](FileCcdb_view_use_by_submitter_summary_editpng.md)
