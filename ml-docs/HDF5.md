...
```
[name@server ~]$ module load hdf5/1.14.2

```

## Submission scripts

Please refer to the page "[Running jobs](Scheduler.md)" for examples of job scripts for the Slurm workload manager. We recommend you include the module load ... command in your job script.
...
```
[name@server ~]$ module load hdf5-mpi/1.14.2
